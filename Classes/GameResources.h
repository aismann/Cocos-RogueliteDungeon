...
const std::string ELF_F_PLIST = "hero/elf_f.plist";
const std::string ELF_F_BODY_PLIST = "hero/elf_f_body.plist";
const std::string ELF_F_HIT = "elf_f_hit";
const std::string ELF_F_IDLE = "elf_f_idle";
const std::string ELF_F_RUN = "elf_f_run";
/*-----------Knight----------------*/
...
const std::string KNIGHT_F_PLIST = "hero/knight_f.plist";
const std::string KNIGHT_F_BODY_PLIST = "hero/knight_f_body.plist";
const std::string KNIGHT_F_HIT = "knight_f_hit";
const std::string KNIGHT_F_IDLE = "knight_f_idle";
const std::string KNIGHT_F_RUN = "knight_f_run";
/*-----------Lizard----------------*/
...
const std::string LIZARD_F_PLIST = "hero/lizard_f.plist";
const std::string LIZARD_F_BODY_PLIST = "hero/lizard_f_body.plist";
const std::string LIZARD_F_HIT = "lizard_f_hit";
const std::string LIZARD_F_IDLE = "lizard_f_idle";
const std::string LIZARD_F_RUN = "lizard_f_run";
/*-----------Wizard----------------*/
const std::string WIZARD_M_PLIST = "hero/wizard_m.plist";
const std::string WIZARD_M_BODY_PLIST = "hero/wizard_m_body.plist";
const std::string WIZARD_M_HIT = "wizard_m_hit";
const std::string WIZARD_M_IDLE = "wizard_m_idle";
const std::string WIZARD_M_RUN = "wizard_m_run";
